...
Page({
  ...
  showlove: function () {
    ...
    this.getLoveData();
    console.log(this.data.ifShowBanner)
  },
  weektopic: function () {
    this.onLoad();
    this.setData({
  ...
  getBannerData: function () {
    var that = this;
    wx.request({
      url: 'https://api.lengren.com.cn/banner/getBannerList',
      data: {
        type: '2'
      },
      header: {
  ...
  getLoveData:function(event){
    var that = this;
    wx.request({
      url: 'https://api.lengren.com.cn/love/getLoveList',
      data:{
        userId:userId,
        page:'1'
      },
    ...
    wx.request({
      ...
      success: function (res) {
        ...
        for (var i = 0; i < res.data.data.length; i++) {
          ...
          console.log('imgTopicLen')
          console.log(that.data.imgTopicLen)
        }
      },
      fail: function (err) {},//请求失败
      complete: function () { }//请求完成后执行的函数
